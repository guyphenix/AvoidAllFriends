...
TheWalkingLady.MainMenu.prototype = {
	create: function () {
		...
		//  Add play button
		play = this.add.button(60, 230, 'buttonAtlas', startGame, this, 'btn_Play_Hover', 'btn_Play');
		...
		help = this.add.button(60, 335, 'buttonAtlas', helpPlayer, this, 'btn_HowToPlay_Hover', 'btn_HowToPlay');
		...
		//  Add credits button
		about = this.add.button(60, 415, 'buttonAtlas', showCreds, this, 'btn_Credits_Hover', 'btn_Credits');
